...
can do t-test for predicted vs observed, for predator contribution to spa var. will check for equal variance first (is equal) so continue with standard 2 sample t test. 
